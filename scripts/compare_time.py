...
def stop_process(proc):
    ...
    try:
        ...
        print('Killing pid %d failed. Please check manually to avoid memory exhaustion.' % proc.pid)
...
for s in solvers:
    ...
    try:
        CUR_PROC = subprocess.Popen(solvers[s] + [filename], stdout = subprocess.PIPE, stderr = subprocess.PIPE)
